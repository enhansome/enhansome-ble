...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,338 | 🐛 3,865 | 🌐 C | 📅 2026-08-28 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,909 | 🐛 2,805 | 🌐 C++ | 📅 2026-08-29 - Matter
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,118 | 🐛 22 | 🌐 C++ | 📅 2026-08-26 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 550 | 🐛 78 | 🌐 Python | 📅 2026-08-28 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,186 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-27 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 486 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-28 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,405 | 🐛 58 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,877 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 224 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-27 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,895 | 🐛 1,673 | 🌐 C | 📅 2026-08-28 - Espressif IoT Development Framework
...
Thank you to all [contributors](https://github.com/dotintent/awesome-ble/graphs/contributors) ⭐ 146 | 🐛 2 | 📅 2025-05-30; you rock!
