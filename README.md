...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,489 | 🐛 3,827 | 🌐 C | 📅 2026-09-11 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,950 | 🐛 2,787 | 🌐 C++ | 📅 2026-09-12 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,552 | 🐛 71 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,130 | 🐛 21 | 🌐 C++ | 📅 2026-09-08 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 555 | 🐛 78 | 🌐 Python | 📅 2026-09-11 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,193 | 🐛 66 | 🌐 Kotlin | 📅 2026-09-11 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 488 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-09 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,412 | 🐛 60 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Flutter Reactive BLE](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 736 | 🐛 158 | 🌐 Dart | 📅 2026-08-24 - Flutter Reactive BLE is a Flutter library that handles BLE operations for multiple devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,970 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 225 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-11 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [niimbot-web-bluetooth](https://github.com/iscarelli/niimbot-web-bluetooth) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Zero-dependency Web Bluetooth driver for NIIMBOT thermal label printers, with reverse-engineered protocol documentation.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,998 | 🐛 1,684 | 🌐 C | 📅 2026-09-11 - Espressif IoT Development Framework
...
Thank you to all [contributors](https://github.com/dotintent/awesome-ble/graphs/contributors) ⭐ 148 | 🐛 2 | 📅 2026-09-11; you rock!
