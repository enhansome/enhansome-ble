...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,310 | 🐛 3,889 | 🌐 C | 📅 2026-08-26 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,897 | 🐛 2,808 | 🌐 C++ | 📅 2026-08-26 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,551 | 🐛 92 | 🌐 C | 📅 2026-08-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,118 | 🐛 30 | 🌐 C++ | 📅 2026-08-25 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 546 | 🐛 77 | 🌐 Python | 📅 2026-08-25 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,185 | 🐛 60 | 🌐 Kotlin | 📅 2026-08-25 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,404 | 🐛 58 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,857 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,874 | 🐛 1,677 | 🌐 C | 📅 2026-08-25 - Espressif IoT Development Framework
