...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,610 | 🐛 3,956 | 🌐 C | 📅 2026-09-25 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,951 | 🐛 2,864 | 🌐 C++ | 📅 2026-09-25 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,556 | 🐛 84 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,132 | 🐛 21 | 🌐 C++ | 📅 2026-09-24 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 559 | 🐛 75 | 🌐 Python | 📅 2026-09-25 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,198 | 🐛 71 | 🌐 Kotlin | 📅 2026-09-25 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 20,024 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 224 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-17 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [ArduinoBLE](https://github.com/arduino-libraries/ArduinoBLE) ⭐ 360 | 🐛 136 | 🌐 C++ | 📅 2026-06-22 - ArduinoBLE library for Arduino
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 19,086 | 🐛 1,691 | 🌐 C | 📅 2026-09-24 - Espressif IoT Development Framework
