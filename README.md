...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,591 | 🐛 4,056 | 🌐 C | 📅 2026-09-23 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,951 | 🐛 2,855 | 🌐 C++ | 📅 2026-09-23 - Matter
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,132 | 🐛 21 | 🌐 C++ | 📅 2026-09-22 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 559 | 🐛 76 | 🌐 Python | 📅 2026-09-22 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,198 | 🐛 69 | 🌐 Kotlin | 📅 2026-09-22 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 20,020 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 19,078 | 🐛 1,682 | 🌐 C | 📅 2026-09-22 - Espressif IoT Development Framework
