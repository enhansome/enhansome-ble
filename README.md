...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,498 | 🐛 3,833 | 🌐 C | 📅 2026-09-12 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,950 | 🐛 2,791 | 🌐 C++ | 📅 2026-09-13 - Matter
...
* [Flutter Reactive BLE](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 737 | 🐛 158 | 🌐 Dart | 📅 2026-08-24 - Flutter Reactive BLE is a Flutter library that handles BLE operations for multiple devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,971 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [niimbot-web-bluetooth](https://github.com/iscarelli/niimbot-web-bluetooth) ⭐ 24 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - Zero-dependency Web Bluetooth driver for NIIMBOT thermal label printers, with reverse-engineered protocol documentation.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 19,006 | 🐛 1,686 | 🌐 C | 📅 2026-09-11 - Espressif IoT Development Framework
