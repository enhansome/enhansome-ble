...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,357 | 🐛 3,880 | 🌐 C | 📅 2026-08-31 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,909 | 🐛 2,795 | 🌐 C++ | 📅 2026-08-31 - Matter
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,120 | 🐛 23 | 🌐 C++ | 📅 2026-08-26 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,187 | 🐛 63 | 🌐 Kotlin | 📅 2026-08-31 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,917 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,906 | 🐛 1,679 | 🌐 C | 📅 2026-08-28 - Espressif IoT Development Framework
