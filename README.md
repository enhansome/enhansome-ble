...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,207 | 🐛 3,841 | 🌐 C | 📅 2026-08-14 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,870 | 🐛 2,769 | 🌐 C++ | 📅 2026-08-14 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,552 | 🐛 85 | 🌐 C | 📅 2026-08-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
...
* [bumble](https://github.com/google/bumble) ⭐ 543 | 🐛 78 | 🌐 Python | 📅 2026-07-23 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,181 | 🐛 60 | 🌐 Kotlin | 📅 2026-08-13 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,400 | 🐛 57 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 1,001 | 🐛 8 | 🌐 Dart | 📅 2026-08-10 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,791 | 🐛 43 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 223 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-13 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,774 | 🐛 1,671 | 🌐 C | 📅 2026-08-13 - Espressif IoT Development Framework
