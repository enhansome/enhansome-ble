...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,404 | 🐛 3,839 | 🌐 C | 📅 2026-09-05 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,928 | 🐛 2,816 | 🌐 C++ | 📅 2026-09-05 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,553 | 🐛 85 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,127 | 🐛 21 | 🌐 C++ | 📅 2026-09-02 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 553 | 🐛 77 | 🌐 Python | 📅 2026-09-04 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,190 | 🐛 62 | 🌐 Kotlin | 📅 2026-09-03 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 487 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-04 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,931 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 225 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-03 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [Awesome Bluetooth Security](https://github.com/engn33r/awesome-bluetooth-security) ⭐ 612 | 🐛 0 | 📅 2025-10-03 - An awesome repo related to Bluetooth (and also BLE) realted security
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,946 | 🐛 1,679 | 🌐 C | 📅 2026-09-04 - Espressif IoT Development Framework
