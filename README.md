...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,602 | 🐛 4,013 | 🌐 C | 📅 2026-09-24 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,950 | 🐛 2,862 | 🌐 C++ | 📅 2026-09-24 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,554 | 🐛 84 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,132 | 🐛 21 | 🌐 C++ | 📅 2026-09-23 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 559 | 🐛 77 | 🌐 Python | 📅 2026-09-24 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [iOS DFU Library](https://github.com/NordicSemiconductor/IOS-DFU-Library) ⭐ 589 | 🐛 17 | 🌐 Swift | 📅 2026-09-19 - DFU application allows to flash new firmware on the DK.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,198 | 🐛 66 | 🌐 Kotlin | 📅 2026-09-24 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 488 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-19 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 1,005 | 🐛 8 | 🌐 Dart | 📅 2026-09-22 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
* [Flutter Reactive BLE](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 737 | 🐛 161 | 🌐 Dart | 📅 2026-08-24 - Flutter Reactive BLE is a Flutter library that handles BLE operations for multiple devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 20,022 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [niimbot-web-bluetooth](https://github.com/iscarelli/niimbot-web-bluetooth) ⭐ 29 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - Zero-dependency Web Bluetooth driver for NIIMBOT thermal label printers, with reverse-engineered protocol documentation.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 19,084 | 🐛 1,687 | 🌐 C | 📅 2026-09-23 - Espressif IoT Development Framework
...
Thank you to all [contributors](https://github.com/dotintent/awesome-ble/graphs/contributors) ⭐ 150 | 🐛 2 | 📅 2026-09-11; you rock!
