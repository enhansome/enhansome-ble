...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,210 | 🐛 3,835 | 🌐 C | 📅 2026-08-14 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,870 | 🐛 2,774 | 🌐 C++ | 📅 2026-08-15 - Matter
...
* [bluepy](https://github.com/IanHarvey/bluepy) ⭐ 1,632 | 🐛 239 | 🌐 C | 📅 2024-06-24 - A Python interface for Bluetooth LE on Linux.
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,552 | 🐛 87 | 🌐 C | 📅 2026-08-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,113 | 🐛 22 | 🌐 C++ | 📅 2026-08-13 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 542 | 🐛 78 | 🌐 Python | 📅 2026-07-23 - Bumble is a full-featured Bluetooth stack written entirely in Python.
* [pygatt](https://github.com/peplin/pygatt) ⚠️ Archived - A Python library for interacting with BLE devices.
* [Bluetooth](https://github.com/PureSwift/Bluetooth) ⭐ 233 | 🐛 9 | 🌐 Swift | 📅 2026-08-07 - Bluetooth is a Swift multiplatform package with multiple libraries supporting the Bluetooth SIG specifications.
...
* [iOS DFU Library](https://github.com/NordicSemiconductor/IOS-DFU-Library) ⭐ 588 | 🐛 17 | 🌐 Swift | 📅 2026-08-10 - DFU application allows to flash new firmware on the DK.
* [AsyncBluetooth](https://github.com/manolofdez/AsyncBluetooth) ⭐ 201 | 🐛 2 | 🌐 Swift | 📅 2026-05-30 - A small library that adds concurrency to CoreBluetooth APIs.
* [CombineCoreBluetooth](https://github.com/StarryInternet/CombineCoreBluetooth) ⭐ 142 | 🐛 3 | 🌐 Swift | 📅 2024-10-31 - CombineCoreBluetooth is a library that bridges Apple's CoreBluetooth framework and Apple's Combine framework.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,181 | 🐛 59 | 🌐 Kotlin | 📅 2026-08-14 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 482 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-09 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.

## Android

*Android libraries, tools, and resources for integrating Bluetooth Low Energy (BLE) functionality into Android applications.*

* [FastBle](https://github.com/Jasonchenlijian/FastBle) ⭐ 5,502 | 🐛 247 | 🌐 Java | 📅 2026-04-17 - An Android Bluetooth Low Energy (BLE) fast development framework.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,399 | 🐛 57 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 1,002 | 🐛 10 | 🌐 Dart | 📅 2026-08-10 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
* [Flutter Reactive BLE](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 734 | 🐛 158 | 🌐 Dart | 📅 2026-05-22 - Flutter Reactive BLE is a Flutter library that handles BLE operations for multiple devices.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,792 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 223 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [Awesome Bluetooth Security](https://github.com/engn33r/awesome-bluetooth-security) ⭐ 611 | 🐛 0 | 📅 2025-10-03 - An awesome repo related to Bluetooth (and also BLE) realted security
...
* [ArduinoBLE](https://github.com/arduino-libraries/ArduinoBLE) ⭐ 357 | 🐛 135 | 🌐 C++ | 📅 2026-06-22 - ArduinoBLE library for Arduino
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,779 | 🐛 1,673 | 🌐 C | 📅 2026-08-13 - Espressif IoT Development Framework
...
Thank you to all [contributors](https://github.com/dotintent/awesome-ble/graphs/contributors) ⭐ 145 | 🐛 3 | 📅 2025-05-30; you rock!
