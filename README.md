...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,583 | 🐛 4,009 | 🌐 C | 📅 2026-09-22 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,951 | 🐛 2,858 | 🌐 C++ | 📅 2026-09-22 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,554 | 🐛 82 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,131 | 🐛 21 | 🌐 C++ | 📅 2026-09-22 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 557 | 🐛 78 | 🌐 Python | 📅 2026-09-11 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,197 | 🐛 68 | 🌐 Kotlin | 📅 2026-09-21 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,413 | 🐛 61 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 20,015 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [niimbot-web-bluetooth](https://github.com/iscarelli/niimbot-web-bluetooth) ⭐ 28 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - Zero-dependency Web Bluetooth driver for NIIMBOT thermal label printers, with reverse-engineered protocol documentation.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 19,071 | 🐛 1,677 | 🌐 C | 📅 2026-09-21 - Espressif IoT Development Framework
