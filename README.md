...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,368 | 🐛 3,888 | 🌐 C | 📅 2026-09-01 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,911 | 🐛 2,817 | 🌐 C++ | 📅 2026-09-01 - Matter
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,121 | 🐛 22 | 🌐 C++ | 📅 2026-08-26 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 550 | 🐛 78 | 🌐 Python | 📅 2026-08-31 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,188 | 🐛 62 | 🌐 Kotlin | 📅 2026-08-31 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 485 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-01 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,406 | 🐛 58 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 1,004 | 🐛 8 | 🌐 Dart | 📅 2026-08-17 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,916 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,916 | 🐛 1,682 | 🌐 C | 📅 2026-08-31 - Espressif IoT Development Framework
