...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,322 | 🐛 3,897 | 🌐 C | 📅 2026-08-27 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,905 | 🐛 2,806 | 🌐 C++ | 📅 2026-08-27 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,551 | 🐛 88 | 🌐 C | 📅 2026-08-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
...
* [bumble](https://github.com/google/bumble) ⭐ 547 | 🐛 81 | 🌐 Python | 📅 2026-08-25 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,186 | 🐛 60 | 🌐 Kotlin | 📅 2026-08-26 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 486 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-26 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,865 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,879 | 🐛 1,680 | 🌐 C | 📅 2026-08-27 - Espressif IoT Development Framework
