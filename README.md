...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,376 | 🐛 3,862 | 🌐 C | 📅 2026-09-02 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,911 | 🐛 2,802 | 🌐 C++ | 📅 2026-09-02 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,553 | 🐛 85 | 🌐 C | 📅 2026-08-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,123 | 🐛 21 | 🌐 C++ | 📅 2026-09-02 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,189 | 🐛 61 | 🌐 Kotlin | 📅 2026-09-01 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 485 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-01 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,407 | 🐛 58 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,923 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,924 | 🐛 1,681 | 🌐 C | 📅 2026-09-01 - Espressif IoT Development Framework
