...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,426 | 🐛 3,873 | 🌐 C | 📅 2026-09-07 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,939 | 🐛 2,824 | 🌐 C++ | 📅 2026-09-07 - Matter
...
* [Moddable](https://github.com/Moddable-OpenSource/moddable) ⭐ 1,553 | 🐛 74 | 🌐 C | 📅 2026-09-05 - JavaScript libraries and tools for microcontrollers development. Includes BLE functionality.
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,128 | 🐛 21 | 🌐 C++ | 📅 2026-09-07 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
* [bumble](https://github.com/google/bumble) ⭐ 554 | 🐛 76 | 🌐 Python | 📅 2026-09-07 - Bumble is a full-featured Bluetooth stack written entirely in Python.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,191 | 🐛 62 | 🌐 Kotlin | 📅 2026-09-03 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
* [BlueFalcon](https://github.com/Reedyuk/blue-falcon) ⭐ 488 | 🐛 3 | 🌐 Kotlin | 📅 2026-09-04 - A Bluetooth kotlin multiplatform "Cross-Platform" library for iOS and Android.
...
* [Nordic Semiconductor BLE SDK for Android](https://github.com/NordicSemiconductor/Android-BLE-Library) ⭐ 2,409 | 🐛 58 | 🌐 Java | 📅 2026-07-10 - Official Bluetooth Low Energy SDK provided by Nordic Semiconductor for Android development.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,945 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - A easily extensible and portable framework for security researchers to test BLE security.
...
* [Awesome Bluetooth Security](https://github.com/engn33r/awesome-bluetooth-security) ⭐ 613 | 🐛 0 | 📅 2025-10-03 - An awesome repo related to Bluetooth (and also BLE) realted security
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,956 | 🐛 1,682 | 🌐 C | 📅 2026-09-06 - Espressif IoT Development Framework
