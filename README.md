...
* [Zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,193 | 🐛 3,811 | 🌐 C | 📅 2026-08-12 - Zephyr
* [Matter](https://github.com/project-chip/connectedhomeip) ⭐ 8,866 | 🐛 2,772 | 🌐 C++ | 📅 2026-08-13 - Matter
...
* [bluepy](https://github.com/IanHarvey/bluepy) ⭐ 1,631 | 🐛 239 | 🌐 C | 📅 2024-06-24 - A Python interface for Bluetooth LE on Linux.
...
* [SimpleBLE](https://github.com/OpenBluetoothToolbox/SimpleBLE) ⭐ 1,111 | 🐛 22 | 🌐 C++ | 📅 2026-08-10 - The all-in-one C/C++/Python/Rust Bluetooth LE library for MacOS, iOS, Windows, and Linux.
...
* [iOS DFU Library](https://github.com/NordicSemiconductor/IOS-DFU-Library) ⭐ 587 | 🐛 17 | 🌐 Swift | 📅 2026-08-10 - DFU application allows to flash new firmware on the DK.
...
* [Kable](https://github.com/JuulLabs/kable) ⭐ 1,181 | 🐛 59 | 🌐 Kotlin | 📅 2026-08-12 - Kotlin Asynchronous Bluetooth Low Energy provides a simple Coroutines-powered API for interacting with Bluetooth Low Energy devices.
...
* [FastBle](https://github.com/Jasonchenlijian/FastBle) ⭐ 5,501 | 🐛 247 | 🌐 Java | 📅 2026-04-17 - An Android Bluetooth Low Energy (BLE) fast development framework.
...
* [Flutter Blue Plus](https://github.com/boskokg/flutter_blue_plus) ⭐ 1,002 | 🐛 8 | 🌐 Dart | 📅 2026-08-10 - Flutter Blue Plus is a bluetooth plugin for Flutter, a new app SDK to help developers build modern multi-platform apps.
...
* [Bettercap](https://github.com/bettercap/bettercap) ⭐ 19,778 | 🐛 44 | 🌐 Go | 📅 2026-08-11 - A easily extensible and portable framework for security researchers to test BLE security.
* [nRF Connect](https://github.com/NordicSemiconductor/pc-nrfconnect-core) ⭐ 223 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-12 - An application framework for developing, testing, and provisioning devices based on Nordic Semiconductor chips.
...
* [ESP-IDF](https://github.com/espressif/esp-idf) ⭐ 18,766 | 🐛 1,667 | 🌐 C | 📅 2026-08-12 - Espressif IoT Development Framework
